...
from scripts.web.routes.dashboard_page import bp as dashboard_bp
...
from scripts.web.routes.prescreen_page import bp as prescreen_bp
...
def register_routes(app):
    ...
    if "web_dashboard" not in app.blueprints:
    ...
    if "web_prescreen" not in app.blueprints:
        app.register_blueprint(prescreen_bp)
