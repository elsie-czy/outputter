...
| # | 文件 | 为什么读 |
|---|------|----------|
| 1 | `docs/guides/ui-rules.md` | **全项目 UI 规范**，颜色/字体/卡片/按钮/状态/图标全部从这里取 |
| 2 | `docs/guides/项目目录结构规范.md` | 模板文件放哪、CSS/JS 放哪、命名规范 |
| 3 | `docs/guides/开发规范手册.md` | Jinja2 模板规范、JS 编码规范、文件长度限制 |
| 4 | `docs/guides/线程协作规范.md` | 分支规则、提交格式、交接摘要模板 |
| 5 | `docs/planning/V2_PLAN.md` §6 页面层级结构 | 导航架构、页面与模板映射关系 |
